...
flags.DEFINE_integer('neg_sample_size', 20, 'number of negative samples') #20
...
flags.DEFINE_integer('validate_batch_size', 16, "how many nodes per validation sample.")
...
def train(train_data, test_data=None):
    ...
    id_map = train_data[2]
    print("Punto 1 fx train")
    if not features is None:
        # pad with dummy zero vector
        features = np.vstack([features, np.zeros((features.shape[1],))])

    context_pairs = train_data[3] if FLAGS.random_context else None
    print("Punto 2 funzione train")
    placeholders = construct_placeholders()
    print("Punto 3 funzione train")
    ...
    print("Punto 4 funzione train")
    adj_info_ph = tf.placeholder(tf.int32, shape=minibatch.adj.shape)
    print("Punto 5 funzione train")
    adj_info = tf.Variable(adj_info_ph, trainable=False, name="adj_info")
    print("Punto 6 funzione train")
